...
# 调用函数并传入文件名、moi 和 it
# modify_xml('FT_MOI_IT.xml', 500, 9)

# try:
#     validate_moi(MOI)
    # print("All rows are valid.")
    # modify_xml('FT_MOI_IT.xml')
# except ValueError as e:
#     print(e)
# 调用函数并传入文件名

def main():
    parser = argparse.ArgumentParser(description="Modify an XML file based on MOI and IT values")
    ...
    validate_moi(MOI)
    modify_xml(args.filename, args.moi, args.it)
